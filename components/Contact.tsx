...
const links = [
  ...
  {
    label: "LinkedIn",
    value: "linkedin.com/in/pawangujral",
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          {links.map((link, i) => (
            <motion.a
              ...
              className="glass-card px-6 py-4 flex items-center gap-3 text-foreground/80 hover:text-accent transition-colors"
              initial={{ opacity: 0, y: 20 }}
              animate={isInView ? { opacity: 1, y: 0 } : {}}
